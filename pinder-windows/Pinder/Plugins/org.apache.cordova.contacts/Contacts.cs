...
namespace WPCordovaClassLib.Cordova.Commands
{
    ...
    public class Contacts : BaseCommand
    {
        ...
        private void contacts_SearchCompleted(object sender, ContactsSearchEventArgs e)
        {
            ...
            //https://jira.exadel.com/browse/ETST-22518 workaround
            if (searchParams.fields.Length == 1 && searchParams.fields[0] == "*")
            {
                searchParams.fields = new string[] { "emails", "displayName", "name", "phoneNumbers", "urls"};
            }
